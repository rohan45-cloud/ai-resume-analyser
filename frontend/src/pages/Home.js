...
import { FiCheck, FiUpload, FiZap, FiBarChart2, FiShield } from 'react-icons/fi';
...
const StepCard = ({ number, title, description }) => (
    <div className="flex gap-4 items-start">
        <div className="w-10 h-10 rounded-xl bg-blue-600 text-white font-bold flex items-center justify-center shrink-0 text-sm shadow-lg shadow-blue-200">{number}</div>
        <div>
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
                    <div className="max-w-4xl mx-auto text-center">
                        ...
                        <h1 className="text-5xl lg:text-6xl font-extrabold text-gray-900 mb-6 leading-tight text-balance">
                            Make Your Resume <span className="gradient-text block">Beat Every ATS</span>
                        </h1>
